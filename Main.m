...
disp(' - "Puppets"               - to reproduce the figure of the puppets toy example (Figures 1+2)')
disp(' - "Simulations"           - to reproduce the figures from the simulations (2DTori - Figures 3+4, 2DFlat - Figures 15+16 in the SM).')
disp(' - "ENose-Figures"         - to reproduce the figures from the  E-Nose experiment (Figure 6 and Figure 12 in the SM)')
disp(' - "ENose-Table"           - to reproduce a table summarizing the objective results on the  E-Nose dataset (Table 1).')
disp(' - "CM-Figures"            - to reproduce the figures from the condition monitoring experiment (Figure 5 and Figure 10 in the SM).')
disp(' - "CM-Table"              - to reproduce a table summarizing the objective results on the condition monitoring dataset (Table 2).')
disp(' - "NoisyMnist-Figures"    - to reproduce the figures from the noisy mnist experiment (Figure 8)')
